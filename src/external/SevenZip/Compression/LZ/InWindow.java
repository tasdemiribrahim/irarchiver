...
public class InWindow
{
	...
	void Free() { _bufferBase = null; }
        ...
        /**
         * bufferde tutulan offsetden önce yer alan byteların sayısını belirleyen _keepSizeBuffer, offsetden sonra yer
         * alan byteların sayısını belirleyen _keepSizeAfter, ayırılmış bellek miktarını belirleyen blocksize ve 
         * verileri tutan _bufferBase dizisinin boyutunun belirlendiği method.
         * @param keepSizeBefore    Bufferda tutulan offset değerinden once yer alan byteların sayısını belirleyen parametre
         * @param keepSizeAfter     Bufferda tutulan offset değerinden sonra yer alan byteların sayısını belirleyen parametre
         * @param keepSizeReserv    Bufferda rezerve olarak tutulacak byteların sayısını belirtir.
         */
